...
<Note>For more information about the API parameters, see the [API reference](./api-reference/create-an-order).</Note>
...
<Note>For more information about the API parameters, see the [API reference](./api-reference/authorize-payment-for-an-order).</Note>
...
<Note>For more information about the API parameters, see the [API reference](./api-reference/capture-payment-for-an-order).</Note>
...
<Note>For more information about the API parameters, see the [API reference](./api-reference/void-an-authorization).</Note>

---

## Retrieve capture details

You can retrieve details of a capture using the capture ID returned in the capture response.

<CodeGroup>

```bash Sample request
curl -X GET https://api-m.sandbox.example.com/v2/payments/captures/2GG279541U471931P \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer ACCESS-TOKEN'
```
...
<Note>For more information about the API parameters, see the [API reference](./api-reference/get-capture-details).</Note>
